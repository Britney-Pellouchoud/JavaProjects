...
public class RuntimeQuiz {
    ...
    public static Runtime f3_theta_runtime = Runtime.EXPONENTIAL;
    ...
    public static Runtime f6_o_runtime = Runtime.LOG_N;
    ...
    public static Runtime f7_o_runtime = Runtime.LINEAR;
